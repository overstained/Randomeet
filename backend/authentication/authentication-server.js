module.exports = function(application, genericConstants, tokenHandler, authMongoHandler, personalityMongoHandler, iqMongoHandler, gkMongoHandler, genericTools, personalityTools) {
var authenticationConstants 	  	=  require('./authentication-constants')(),
		authenticationService  		  	=  require('./authentication-service')(application, 
			authenticationConstants, genericConstants, tokenHandler, authMongoHandler, personalityMongoHandler, iqMongoHandler, gkMongoHandler, genericTools, personalityTools);
	...
	application.post(genericConstants.UPDATE_USER_PROFILE_URL, function(req, res) {
		var info = req.body,
    	...
    	authenticationService
		.updateUserProfile(user, info, res)
		.catch(function(err){
			res.status(genericConstants.INTERNAL_ERROR).json({
				message : err.message,
    			trace: 'A-SRV-UP'
